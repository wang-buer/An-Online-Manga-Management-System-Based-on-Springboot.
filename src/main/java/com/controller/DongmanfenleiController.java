...
public class DongmanfenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DongmanfenleiEntity dongmanfenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DongmanfenleiEntity dongmanfenlei, HttpServletRequest request){
        EntityWrapper<DongmanfenleiEntity> ew = new EntityWrapper<DongmanfenleiEntity>();
		PageUtils page = dongmanfenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, dongmanfenlei), params), params));
        return R.ok().put("data", page);
    }
